...
extern const ColumnInfo kAbilOneColInfo = ColumnInfo("Ability 1", "pretty_ability_1", true, false, ImGuiTableColumnFlags_WidthFixed, AbilOneColumnId, 0);
extern const ColumnInfo kAbilTwoColInfo = ColumnInfo("Ability 2", "pretty_ability_2", true, false, ImGuiTableColumnFlags_WidthFixed, AbilTwoColumnId, 0);
extern const ColumnInfo kAbilHiddenColInfo = ColumnInfo("Hidden Ability", "pretty_hidden_ability", true, false, ImGuiTableColumnFlags_WidthFixed, AbilHiddenColumnId, 0);
