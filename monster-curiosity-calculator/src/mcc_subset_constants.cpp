...
extern const ColumnInfo kNameColInfo = ColumnInfo("Name", "pretty_name", false, true, ImGuiTableColumnFlags_WidthFixed, NameColumnId, 90.0f);
extern const ColumnInfo kDexNumColInfo = ColumnInfo("Dex #", "dex_number", true, true, ImGuiTableColumnFlags_WidthFixed, DexColumnId, 0);
...
extern const ColumnInfo kHeightColInfo = ColumnInfo("Height (m)", "height", true, true, ImGuiTableColumnFlags_WidthFixed, HeightColumnId, 0);
extern const ColumnInfo kWeightColInfo = ColumnInfo("Weight (kg)", "weight", true, true, ImGuiTableColumnFlags_WidthFixed, WeightColumnId, 0);
...
extern const ColumnInfo kBaseExpColInfo = ColumnInfo("Base Experience", "base_experience", true, true, ImGuiTableColumnFlags_WidthFixed, BaseExpColumnId, 0);
extern const ColumnInfo kBaseHappyColInfo = ColumnInfo("Base Happiness", "base_happiness", true, true, ImGuiTableColumnFlags_WidthFixed, BaseHappyColumnId, 0);
extern const ColumnInfo kCatchRateColInfo = ColumnInfo("Catch Rate", "catch_rate", true, true, ImGuiTableColumnFlags_WidthFixed, CatchRateColumnId, 0);
...
extern const ColumnInfo kAbilOneColInfo = ColumnInfo("Ability 1", "pretty_ability_1", true, true, ImGuiTableColumnFlags_WidthFixed, AbilOneColumnId, 0);
extern const ColumnInfo kAbilTwoColInfo = ColumnInfo("Ability 2", "pretty_ability_2", true, true, ImGuiTableColumnFlags_WidthFixed, AbilTwoColumnId, 0);
extern const ColumnInfo kAbilHiddenColInfo = ColumnInfo("Hidden Ability", "pretty_hidden_ability", true, true, ImGuiTableColumnFlags_WidthFixed, AbilHiddenColumnId, 0);
extern const ColumnInfo kHealthColInfo = ColumnInfo("Health", "hp", true, true, ImGuiTableColumnFlags_WidthFixed, HealthColumnId, 0);
extern const ColumnInfo kAttackColInfo = ColumnInfo("Attack", "attack", true, true, ImGuiTableColumnFlags_WidthFixed, AttackColumnId, 0);
extern const ColumnInfo kDefenseColInfo = ColumnInfo("Defense", "defense", true, true, ImGuiTableColumnFlags_WidthFixed, DefenseColumnId, 0);
extern const ColumnInfo kSpeAtkColInfo = ColumnInfo("Special Attack", "special_attack", true, true, ImGuiTableColumnFlags_WidthFixed, SpeAtkColumnId, 0);
extern const ColumnInfo kSpeDefColInfo = ColumnInfo("Special Defense", "special_defense", true, true, ImGuiTableColumnFlags_WidthFixed, SpeDefColumnId, 0);
