...
App::App() {
	...
	App::wc = {sizeof(wc), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(nullptr), nullptr, nullptr, nullptr, nullptr, L"ImGui Example", nullptr};
	::RegisterClassExW(&wc);
	...
	clear_color = kMidnightColor.GetColorValues();
}
