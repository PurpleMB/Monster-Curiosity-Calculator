...
#include "data_communication/mcc_parameter_constants.h"
#include "data_communication/mcc_value_structs.h"
#include "data_communication/mcc_value_constants.h"
#include "data_communication/mcc_subset_structs.h"
#include "data_communication/mcc_subset_constants.h"
...
public:
	...
	virtual void StartUp() final {
		// load font atlas
		{
			...
			font_sono = io.Fonts->AddFontFromFileTTF("./resources/fonts/Sono-Regular.ttf", size_in_pixels);
		}
		...
		// load images into textures
		{
			...
			bool ph_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/placeholder.png", &test_texture, &ph_image_width, &ph_image_height);
			IM_ASSERT(ph_ret);
			...
			bool logo_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/mcclogo.png", &logo_texture, &logo_image_width, &logo_image_height);
			IM_ASSERT(ph_ret);
			...
			bool remove_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/x-icon.png", &remove_texture, &remove_image_width, &remove_image_height);
			...
			bool edit_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/cog-icon.png", &edit_texture, &edit_image_width, &edit_image_height);
			IM_ASSERT(edit_ret);
			...
			bool redo_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/redo-icon.png", &redo_texture, &redo_image_width, &redo_image_height);
			IM_ASSERT(redo_ret);
			...
			bool lock_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/locked-icon.png", &lock_texture, &lock_image_width, &lock_image_height);
			IM_ASSERT(lock_ret);
			...
			bool unlock_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/unlocked-icon.png", &unlock_texture, &unlock_image_width, &unlock_image_height);
			...
			bool help_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/help-icon.png", &help_texture, &help_image_width, &help_image_height);
			IM_ASSERT(help_ret);
			...
			bool body_01_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/bodies/01_Ball.png", &body_01_texture, &body_01_width, &body_01_height);
			...
			bool body_02_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/bodies/02_Squiggle.png", &body_02_texture, &body_02_width, &body_02_height);
			...
			bool body_03_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/bodies/03_Fish.png", &body_03_texture, &body_03_width, &body_03_height);
			...
			bool body_04_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/bodies/04_Arms.png", &body_04_texture, &body_04_width, &body_04_height);
			...
			bool body_05_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/bodies/05_Blob.png", &body_05_texture, &body_05_width, &body_05_height);
			...
			bool body_06_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/bodies/06_Upright.png", &body_06_texture, &body_06_width, &body_06_height);
			...
			bool body_07_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/bodies/07_Legs.png", &body_07_texture, &body_07_width, &body_07_height);
			...
			bool body_08_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/bodies/08_Quadruped.png", &body_08_texture, &body_08_width, &body_08_height);
			...
			bool body_09_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/bodies/09_Wings.png", &body_09_texture, &body_09_width, &body_09_height);
			...
			bool body_10_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/bodies/10_Tentacles.png", &body_10_texture, &body_10_width, &body_10_height);
			...
			bool body_11_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/bodies/11_Heads.png", &body_11_texture, &body_11_width, &body_11_height);
			...
			bool body_12_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/bodies/12_Humanoid.png", &body_12_texture, &body_12_width, &body_12_height);
			...
			bool body_13_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/bodies/13_Insect.png", &body_13_texture, &body_13_width, &body_13_height);
			...
			bool body_14_ret = purple_mb::imgui_app::LoadTextureFromFile("./resources/images/bodies/14_Armor.png", &body_14_texture, &body_14_width, &body_14_height);
...
private:
	...
	std::vector<ColumnStatus> subset_column_statuses = {
		...
		ColumnStatus(kPrimTypeColInfo, true),
		ColumnStatus(kSecTypeColInfo, true),
