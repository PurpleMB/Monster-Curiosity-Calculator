// PurpleMB: This code is almost entirely pulled from the example
// ImGui program for DX11. It has simply been segmented as part of the
// App framework to make the template more easily reusable
#pragma once
...
App::App(std::wstring app_name, std::wstring app_version, ImVec2 window_pos, ImVec2 window_size) {
    ...
    clear_color = ImVec4(0.0f / 255.0f, 0.0f / 255.0f, 0.0f / 255.0f, 1.0f);
}
